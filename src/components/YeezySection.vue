...
<template>
  <section
    :class="[
      'sneaker-section',
      'yeezy-gradient',
      activeSection === 'yeezy' ? 'expanded' : '',
      activeSection && activeSection !== 'yeezy' ? 'shrunk' : '',
    ]"
    @click="$emit('setActiveSection', 'yeezy')"
  >
    <div class="flex flex-col items-center justify-center h-full relative">
      <h2 class="sneaker-title-bg">YEEZY</h2>
      <div class="sneaker-image-container">
        <img src="/images/yeezy.png" alt="Yeezy Sneaker" class="sneaker-image" />
      </div>
      <h2 class="sneaker-title-front">YEEZY</h2>
    </div>
  </section>
</template>
